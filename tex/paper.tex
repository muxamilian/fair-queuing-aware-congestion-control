...
\begin{figure}[h]
\centering 
\subfloat[\footnotesize A host sending data to a receiver. There is a bottleneck link with a switch which applies \textbf{fair queuing}.]{\includegraphics[width=\columnwidth]{{"figures/fq"}.pdf}
...
\begin{figure}[h]
\centering
\subfloat[\footnotesize A host sending data to a receiver. There is a bottleneck link with a switch which applies \textbf{no fair queuing}.]{\includegraphics[width=\columnwidth]{{"figures/no_fq"}.pdf}
...
We emulate the network using \textit{mininet} and use Linux's \textit{pfifo} queuing discipline in the case there is no fair queuing and \textit{fq} \textit{fq\_codel} for fair queuing. 
...
\begin{figure}[h]
\centering
\subfloat[\footnotesize pfifo]{\includegraphics[width=0.33\columnwidth]{{"../sample/plots/results_pfifo_new_tonopah"}.pdf}
\label{fig:ecdf_pfifo}}
\subfloat[\footnotesize fq\_codel]{\includegraphics[width=0.33\columnwidth]{{"../sample/plots/results_fq_codel_new_tonopah"}.pdf}
\label{fig:ecdf_fq_codel}}
\subfloat[\footnotesize fq]{\includegraphics[width=0.33\columnwidth]{{"../sample/plots/results_fq_new_tonopah"}.pdf}
\label{fig:ecdf_fq}}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{{"../sample/plots/results_pfifo_new_tonopah_all"}.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{{"../sample/plots/results_fq_codel_new_tonopah_all"}.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{{"../sample/plots/results_fq_new_tonopah_all"}.pdf}
...
\begin{figure}[h]
\centering
\subfloat[\footnotesize pfifo]{\includegraphics[width=0.33\columnwidth]{{"../sample/plots/results_pfifo_new_tonopah_iperf"}.pdf}
\label{fig:ecdf_crosstraffic_pfifo}}
\subfloat[\footnotesize fq]{\includegraphics[width=0.33\columnwidth]{{"../sample/plots/results_fq_new_tonopah_iperf"}.pdf}
\label{fig:ecdf_crosstraffic_fq}}
\caption{Empirical cumulative distribution functions for detection of the abscence/presence of fair queuing when there is cross-traffic.}
\label{fig:ecdf_crosstraffic}
\end{figure}            

\begin{figure}
\centering
\includegraphics[width=\columnwidth]{{"../sample/plots/results_pfifo_new_tonopah_iperf_all"}.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{{"../sample/plots/results_fq_new_tonopah_iperf_all"}.pdf}
