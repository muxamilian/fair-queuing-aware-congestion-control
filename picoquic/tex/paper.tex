...
Around seconds 12 and 13.5, the sending rate reaches the maximum of the link -- 50 Mbit/s -- and fair queuing starts to limit the throughput of the subflow that is sending more. 
...
Then they could be sure that the can use their preferred congestion control mechanism, while not bothering or being bothered by other network flows. 
...
This case only occurs when the sending rate is very low ($<$ 10\,Mbit/s). 
